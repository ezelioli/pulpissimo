...
if [info exists ::env(GENERIC_BANK_SIZE)] {
    set GENERIC_BANK_SIZE $::env(GENERIC_BANK_SIZE)
} else {
    set GENERIC_BANK_SIZE 4096
}

set ipName xilinx_generic_ram
...
set_property -dict [eval list CONFIG.Use_Byte_Write_Enable {false} \
                     CONFIG.Byte_Size {1} \
                     CONFIG.Write_Width_A {1} \
                     CONFIG.Write_Depth_A {$GENERIC_BANK_SIZE} \
